function PlotM1(All_Betas)
All_Betas.exp1.mean.m1(1)= mean(All_Betas.exp1.m1(:,1));
All_Betas.exp1.mean.m1(2)= mean(All_Betas.exp1.m1(:,2));
All_Betas.exp1.mean.m1(3)= 0;

All_Betas.exp1.mean.m2(1)= mean(All_Betas.exp1.m2(:,1));
All_Betas.exp1.mean.m2(2)= mean(All_Betas.exp1.m2(:,2));
All_Betas.exp1.mean.m2(3)= mean(All_Betas.exp1.m2(:,3));


y=[[All_Betas.exp1.mean.m1]; [All_Betas.exp1.mean.m2];];
str=({'Model 1','Model 2'});
...
legend();
title('Experiment 1 ','FontSize',72);
